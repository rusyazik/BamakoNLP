...
REPOSITORY_PATH = "https://raw.githubusercontent.com/rusyazik/BamakoNLP/master/"
...
def download_from_github(version, fn, target_dir, force=False):
    url = REPOSITORY_PATH + "{0}/{1}".format(version, fn)
...
def download_ClassificationTextesMultiEtiquette_resources(force=False):
    sequential_downloader(
        "ClassificationTextesMultiEtiquette",
        [
            "train.tsv",
            "validation.tsv",
            "test.tsv",
